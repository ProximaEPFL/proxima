...
class AppActions {
  ...
  static Future<void> expectCommentCount(
    WidgetTester tester,
    String postTitle,
    int count,
  ) async {
  ...
  static Future<void> addComment(WidgetTester tester, String comment) async {
  ...
  static Future<void> openPost(WidgetTester tester, String postTitle) async {
  ...
  static Future<void> bottomBarNavigate(
  ...
  /// refresh button.
  static Future<void> buttonRefresh(WidgetTester tester) async {
    await tester.tap(find.text("Refresh"));
    await tester.pumpAndSettle();
  }

  /// Refreshes the page by flinging down the widget [finder].
  static Future<void> flingRefresh(
    WidgetTester tester,
  ...
  static Future<void> loginToCreateAccount(WidgetTester tester) async {
  ...
  static Future<void> createAccountToHome(WidgetTester tester) async {
  ...
  static Future<void> homeToProfilePage(WidgetTester tester) async {
    expect(find.byType(HomePage), findsOneWidget);
  ...
  static Future<void> bottomNavigation(WidgetTester tester) async {
    expect(find.byType(HomePage), findsOneWidget);
